...
CONTAINS
	...
	SUBROUTINE esf_anguelova(thetai,hz,seaDC,tin,vaf,vfw,evfoam,ehfoam)

	IMPLICIT NONE
! INPUT
	REAL (KIND=8) thetai 			! incidence angle (deg) from air onto foam 
	REAL (KIND=8) hz 			! frequency in gigahertz GHz
...
! Variables for Simpson integration 
	...
	m=0.01					! shape of void fraction profile is nominal exponential function
